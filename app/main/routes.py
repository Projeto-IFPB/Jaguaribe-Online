...
from app.functions import carregar_admins, ler_produtos, guardar_produtos, ler_produtos_card, buscar_whatsapp, ler_todos_usuarios
...
@main_bp.route('/excluir_produto/<id_produto>', methods=['POST'])
@login_required
...
@main_bp.route('/editar_produto/<id_produto>', methods=['GET', 'POST'])
@login_required
